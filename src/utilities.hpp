...
namespace util
{
	...
	static std::vector<double> get_doubles(size_t size, double _min = 1.0, double _max = 1024.0)
	{

		std::uniform_real_distribution<double> dist_double{_min, _max};

		auto gen = [&dist_double]()
		{
	...
	static std::vector<int> get_ints(size_t size, int _min = 0, int _max = 1024)
	{
