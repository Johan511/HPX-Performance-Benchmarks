...
double test(int vector_size, std::size_t chunk_size)
{
	...
	// hpx::annotated_function(hpx::copy_if, "copy_if")(hpx::execution::par.with(scs), vec1.begin(), vec1.end(), vec2.begin(), pred);
	hpx::annotated_function(hpx::copy_if, "copy_if")(hpx::execution::par, vec1.begin(), vec1.end(), vec2.begin(), pred);
	timer.stop();
